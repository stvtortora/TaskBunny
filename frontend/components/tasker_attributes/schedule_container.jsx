...
const mapStateToProps = state => {
  ...
  const render = function () {
    ...
    return !this.props.registrationIds.length && !this.state.editMode ? <div className='placeholder-container'><div onClick={this.toggleEditMode} className='placeholder-text'>+ Add times you're available</div></div> :
    <div className='tasker-attribute-container' id={this.state.editMode ? 'attribute-container-edit' : ''}>
      <div className='tasker-attribute-name' >Edit Schedule</div>
